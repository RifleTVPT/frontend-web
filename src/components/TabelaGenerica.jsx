...
const TabelaGenerica = ({ colunas, children, emptyMessage, iconEmpty = "bi-folder-x", className = "" }) => {
    ...
    return (
        <div className={`card border-0 shadow-sm rounded-4 overflow-hidden mb-5 bg-white ${className}`}>
