                  ...
                  <div className="bg-success bg-opacity-10 p-4 rounded-4 border border-success border-opacity-25 mt-auto">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="m-0 small text-muted">Este badge premium foi adicionado ao perfil do consultor em <strong>{conquista.data}</strong></p>
                      </div>
                    </div>
                  </div>
                ) : (
...
export default DetalhesConquistaEspecialTalent;
